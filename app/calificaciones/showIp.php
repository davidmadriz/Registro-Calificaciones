...
<button class="btn btn-info" onclick="goBack()"> << Back</button> <br>
  ...
  <label class="col-2 col-form-label">Asignatura: </label> <?php echo $secciones->asignatura; ?> 
	...
	<?php 
		{
		$user_id=null;
		$sql2= "select * from calificaciones where periodoEscolar = 'I Periodo' and tipoCalificacion = 'Trabajo Cotidiano' and seccion_id=".$_GET["id"] ;
...
?>
	...
	<?php 
		{
		$user_id=null;
		$sql3= "select * from calificaciones where periodoEscolar = 'I Periodo' and tipoCalificacion = 'Trabajo Extra-Clase' and seccion_id=".$_GET["id"] ;
...
?>
	...
	<?php 
		{
		$user_id=null;
		$sql4= "select * from calificaciones where periodoEscolar = 'I Periodo' and  tipoCalificacion = 'Prueba escrita' and seccion_id=".$_GET["id"] ;
...
?>
	...
	<?php 
		{
		$user_id=null;
		$sql5= "select * from calificaciones where periodoEscolar = 'I Periodo' and tipoCalificacion = 'Concepto' and seccion_id=".$_GET["id"] ;
...
?>
	...
	<?php 
		{
		$user_id=null;
		$sql6= "select * from calificaciones where periodoEscolar = 'I Periodo' and tipoCalificacion = 'Asistencia' and seccion_id=".$_GET["id"];
